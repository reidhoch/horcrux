"""Pre-computed lookup tables for GF(256) operations."""

from typing import Final

__all__: list[str] = ["INVERSE_TABLE"]
...
#
# Each entry i contains the value j such that mul(i, j) = 1 in GF(256).
# Generated using the irreducible polynomial 0x11B (x^8 + x^4 + x^3 + x + 1).
#
# Security Note:
...
INVERSE_TABLE: Final[bytes] = bytes(
    [
        0x00,
        0x01,
        0x8D,
